      ...
      <div style={headerNav}>
        <div style={headerFlex}>
          ...
          <div style={controlsGroup}>
            <button onClick={handleToday} style={todayBtn}>
              Today
            </button>
            <div style={stepperContainer}>
              <button
                onClick={() => setMonthIndex((p) => (p === 0 ? 11 : p - 1))}
                style={navBtn}
              >
                ‹
              </button>
              ...
              <button
                onClick={() => setMonthIndex((p) => (p === 11 ? 0 : p + 1))}
                style={navBtn}
              >
                ›
              </button>
            ...
            <div style={stepperContainer}>
              <button onClick={() => setYear((p) => p - 1)} style={navBtn}>
                ‹
              </button>
      ...
      <div style={layoutGrid}>
        ...
        <div style={{ ...cardStyle, display: "flex", flexDirection: "column" }}>
          ...
          <div style={agendaFooterContainer}>
            <button onClick={() => navigate("/appointment")} style={actionBtn}>
              + New Appointment
            </button>
          </div>
        </div>
...
const monthGrid = {
  ...
  gridTemplateRows: "25px repeat(6, 38px)",
  gap: "6px",
  padding: "15px",
};
const dayHeader = {
